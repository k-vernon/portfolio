        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Atlanta, Georgia, USA</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">kvernon908@gmail.com</span>

              <a href="mailto:kvernon908@gmail.com" className="contact__button">
                Write me{" "} 
